<?php
define('__ALIYUN_BASE__',str_replace('\\','/',dirname(__FILE__)).'/');
require_once __ALIYUN_BASE__.'Core/MimeTypes.php';
require_once __ALIYUN_BASE__.'Core/OssException.php';
require_once __ALIYUN_BASE__.'Http/RequestCore.php';
require_once __ALIYUN_BASE__.'Http/RequestCore_Exception.php';
require_once __ALIYUN_BASE__.'Http/ResponseCore.php';
require_once __ALIYUN_BASE__.'Model/CorsConfig.php';
require_once __ALIYUN_BASE__.'Model/CnameConfig.php';
require_once __ALIYUN_BASE__.'Model/LoggingConfig.php';
require_once __ALIYUN_BASE__.'Model/LiveChannelConfig.php';
require_once __ALIYUN_BASE__.'Model/LiveChannelInfo.php';
require_once __ALIYUN_BASE__.'Model/LiveChannelListInfo.php';
require_once __ALIYUN_BASE__.'Model/StorageCapacityConfig.php';
require_once __ALIYUN_BASE__.'Result/AclResult.php';
require_once __ALIYUN_BASE__.'Result/BodyResult.php';
require_once __ALIYUN_BASE__.'Result/GetCorsResult.php';
require_once __ALIYUN_BASE__.'Result/GetLifecycleResult.php';
require_once __ALIYUN_BASE__.'Result/GetLoggingResult.php';
require_once __ALIYUN_BASE__.'Result/GetRefererResult.php';
require_once __ALIYUN_BASE__.'Result/GetWebsiteResult.php';
require_once __ALIYUN_BASE__.'Result/GetCnameResult.php';
require_once __ALIYUN_BASE__.'Result/GetLocationResult.php';
require_once __ALIYUN_BASE__.'Result/HeaderResult.php';
require_once __ALIYUN_BASE__.'Result/InitiateMultipartUploadResult.php';
require_once __ALIYUN_BASE__.'Result/ListBucketsResult.php';
require_once __ALIYUN_BASE__.'Result/ListMultipartUploadResult.php';
require_once __ALIYUN_BASE__.'Model/ListMultipartUploadInfo.php';
require_once __ALIYUN_BASE__.'Result/ListObjectsResult.php';
require_once __ALIYUN_BASE__.'Result/ListPartsResult.php';
require_once __ALIYUN_BASE__.'Result/PutSetDeleteResult.php';
require_once __ALIYUN_BASE__.'Result/DeleteObjectsResult.php';
require_once __ALIYUN_BASE__.'Result/CopyObjectResult.php';
require_once __ALIYUN_BASE__.'Result/CallbackResult.php';
require_once __ALIYUN_BASE__.'Result/ExistResult.php';
require_once __ALIYUN_BASE__.'Result/PutLiveChannelResult.php';
require_once __ALIYUN_BASE__.'Result/GetLiveChannelHistoryResult.php';
require_once __ALIYUN_BASE__.'Result/GetLiveChannelInfoResult.php';
require_once __ALIYUN_BASE__.'Result/GetLiveChannelStatusResult.php';
require_once __ALIYUN_BASE__.'Result/ListLiveChannelResult.php';
require_once __ALIYUN_BASE__.'Result/GetStorageCapacityResult.php';
require_once __ALIYUN_BASE__.'Result/AppendResult.php';
require_once __ALIYUN_BASE__.'Model/ObjectListInfo.php';
require_once __ALIYUN_BASE__.'Result/UploadPartResult.php';
require_once __ALIYUN_BASE__.'Model/BucketListInfo.php';
require_once __ALIYUN_BASE__.'Model/LifecycleConfig.php';
require_once __ALIYUN_BASE__.'Model/RefererConfig.php';
require_once __ALIYUN_BASE__.'Model/WebsiteConfig.php';
require_once __ALIYUN_BASE__.'Model/XmlConfig.php';
require_once __ALIYUN_BASE__.'Core/OssUtil.php';
require_once __ALIYUN_BASE__.'Model/ListPartsInfo.php';
require_once __ALIYUN_BASE__.'Result/SymlinkResult.php';
