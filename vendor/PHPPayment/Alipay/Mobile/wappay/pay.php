...
require_once dirname ( __FILE__ ).DIRECTORY_SEPARATOR.'/../lotusphp_runtime/ObjectUtil/ObjectUtil.php';
...
<script language="javascript">
	...
	function submit()
	{
		...
		$.post('http://www.wangchao.com/alipay/wappay/pay.php',param,function(){
