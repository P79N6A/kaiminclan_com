...
class CatalogueEnableController extends Controller {
	...
	public function fire(){
		...
		if($groupInfo['status'] == IntelligenceCatalogueModel::PAGINATION_BLOCK_STATUS_DISABLED){
			$this->service('IntelligenceCatalogue')->update(array('status'=>IntelligenceCatalogueModel::PAGINATION_BLOCK_STATUS_ENABLE),$catalogueId);
		}
