...
class CatalogEnableController extends Controller {
	...
	public function fire(){
		...
		if($groupInfo['status'] == MaterialCatalogModel::PAGINATION_BLOCK_STATUS_DISABLED){
			$this->service('MaterialCatalog')->update(array('status'=>MaterialCatalogModel::PAGINATION_BLOCK_STATUS_ENABLE),$catalogId);
		}
