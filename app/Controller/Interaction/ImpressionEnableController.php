...
class CommentSaveController extends Controller {
	...
	public function fire(){
		...
		if($impressionData['status'] == InteractionImpressionModel::INTERACTION_IMPRESSION_STATUS_DISABLE){
			$this->service('InteractionImpression')->update(array('status'=>InteractionImpressionModel::INTERACTION_IMPRESSION_STATUS_ENABLE),$impressionId);
		}
