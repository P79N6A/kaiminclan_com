...
class QuartersDisableController extends Controller {
	...
	public function fire(){
		...
		if($quartersInfo['status'] == RecruitmentQuartersModel::PAGINATION_BLOCK_STATUS_ENABLE){
			$this->service('RecruitmentQuarters')->update(array('status'=>RecruitmentQuartersModel::PAGINATION_BLOCK_STATUS_DISABLED),$quartersId);
		}
	}
}
?>