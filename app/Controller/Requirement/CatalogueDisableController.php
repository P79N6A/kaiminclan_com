...
class CatalogueDisableController extends Controller {
	...
	public function fire(){
		...
		if($catalogueInfo['status'] == RequirementCatalogueModel::BILLBOARD_CATALOGUE_STATUS_ENABLE){
			$this->service('RequirementCatalogue')->update(array('status'=>RequirementCatalogueModel::BILLBOARD_CATALOGUE_STATUS_DISABLED),$catalogueId);
		}
	}
}
?>