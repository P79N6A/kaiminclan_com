...
class AdjustmentDisableController extends Controller {
	...
	public function fire(){
		...
		if($groupInfo['status'] == DealingsAdjustmentModel::PAGINATION_BLOCK_STATUS_ENABLE){
			$this->service('DealingsAdjustment')->update(array('status'=>DealingsAdjustmentModel::PAGINATION_BLOCK_STATUS_DISABLED),$adjustmentId);
		}
	}
}
?>